...
This document is archived and may contain outdated information. It describes the legacy cloud-to-cloud integration methods that were used with the Sourceful Energy Gateway. For current development guidance, please refer to the [Zap Developer Documentation](/technical/zap-for-developers).
:::
