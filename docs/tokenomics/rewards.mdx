...
During this phase, the pool of beta tokens is currently set at **20 million Beta Points**. 
...
* Each gateway's share of the 10 million SRC is calculated as:
  * `(Gateway's Points ÷ Total Points) × 10,000,000 SRC`
...
* Validated Gateway: (20 ÷ 31.5) × 10,000,000 = 6,349,206 SRC
* Hardware Gateway: (10 ÷ 31.5) × 10,000,000 = 3,174,603 SRC
* API Gateway: (1.5 ÷ 31.5) × 10,000,000 = 476,191 SRC
